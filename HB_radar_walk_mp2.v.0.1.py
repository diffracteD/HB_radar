...
################################################################################################################
                    ...
                    PROGRAM NAME: HB_radar_walk_MP2_v0.1 (8.10.2015)
...
def show_me_hbs(path):
                        ...
                        for item in glu_inp_file:
                            if item[2] == 'CD':
                                ...
                                if glu_search_string_c == glu_target_string_d:
                                    #print glu_search_string_c,glu_target_string_d
                                    #print line,item
                                    adjacent_glu.append(item)
                                    acceptor_glu.append(line)
                                    #print item
    ...
    for root, dirs, files in os.walk(path):
        ...
        for DA_cal_file in list_of_DA_cal_files:
            ...
            hbinfo_out.write(h1)
            hbinfo_out.write('\n')
            header_line = str( "DONOR"+" "*20+"HYDROGEN-ATOM"+" "*12+"ACCEPTOR ATOM"+" "*12+"ADJACENT ATOM"+" "*10+"DA"+\
                               " "*6+"HA"+" "*7+"DHA"+" "*7+"HAAj"+" "*9+"DAAj"+" "*9+"MP2")   #headers line. . .
            ...
            #$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$       
            #---------------------------------------------------------------------------------------------------------------
            #       ...............PREPARING FOR MP2 INPUT CONFIGURATION...............................
            ...
            def analyze_mp2_code(mp2_code_exe,xc,func_name):
                mp2_out = open(path + "e_hydroden_bond.data",'w')
                p =subprocess.Popen(['mpirun -np 16 nwchem ' + mp2_code_exe], stdout=subprocess.PIPE, shell=True)
                output, err = p.communicate()
                #print "communication successful with nwchem"
                for line in output:
                    mp2_out.write(line)
                mp2_out.close()
                mp2_file = open(path + "e_hydroden_bond.data",'r').read().strip().split('\n')
                ...
                for lines in map(str.split,mp2_file):
                    if lines != []:
                        if lines[0] == 'Total' and lines[1] == 'MP2' and lines[2] == 'energy':
            ...
            for items in dft_input_list:
                ...
                #For atom 1...
                if split_items[0] == 'N':
                    atom_A_electron_num = 7
                    #atoms.append('7')
                elif split_items[0] == 'O':
                    atom_A_electron_num = 8
                    #atoms.append('8')

                #For atom 2...
                if split_items[3][-1] == 'H':
                    atom_B_electron_num = 1
                    #atoms.extend('1')

                #For atom 3...
                if split_items[6][-1] == 'N':
                    atom_C_electron_num = 7
                elif split_items[6][-1] == 'O':
                    atom_C_electron_num = 8
                elif split_items[6][-1] == 'S':
                    atom_C_electron_num = 16


                #For atom 4...
                if split_items[9][-1] == 'C':
                    atom_D_electron_num = 6
                    #atoms.extend('7')

                #Now calculating total no of electrons for atoms per line..
                total_electron_number = (atom_A_electron_num+atom_B_electron_num+atom_C_electron_num+atom_D_electron_num)
                #print split_items[3][-1], split_items[6][-1], split_items[9][-1] #Debug-step if in confusion...


                #MP2 Calculation module...
                #---------------------------------------------------------------------------
                f_mp2 = open(path+"mp2_template.nw")
                filedata = f_mp2.read()
                f_mp2.close()
                newdata = filedata.replace("  N##", ("  "+items))
                
                mp2_code = open(path+"mp2_e_hydrogen_bond_exe.nw",'w')
                mp2_code.write(newdata)
                mp2_code.close()
                analyze_mp2_code(mp2_code_exe= path+"mp2_e_hydrogen_bond_exe.nw", xc=mp2,func_name='MP2')
                ...
                if (total_electron_number % 2) == 0:   #i.e. number of electron is even, calculation will go on with 'dft protocol'...
                    ...
                    ** New to v.3.1
                    ...
                    try:
                        f_m06_2x = open("/home/saumen/abhisek/project_HBf/dft_m06-2x_631g_template.nw",'r')
                        ...
                        analyze_dft_code(dft_code_exe="/home/saumen/abhisek/project_HBf/e_hydrogen_bond_exe.nw", xc=m06_2x,func_name='m06-2x')
                        ...
                        try:
                            ...
                            f_m06_2x = open("/home/saumen/abhisek/project_HBf/dft_m06-2x_6311g-fine_template.nw",'r')
                            filedata=f_m06_2x.read()
                            f_m06_2x.close()
                            newdata = filedata.replace("  N##",("  "+items))
                        ...
                        #Going for 6-311g(Coarse-grid) exception ...
                            ...
                            try:
                                ...
                                f_m06_2x = open("/home/saumen/abhisek/project_HBf/dft_m06-2x_6311g-coarse_template.nw",'r')
                                filedata=f_m06_2x.read()
                                f_m06_2x.close()
                                newdata = filedata.replace("  N##",("  "+items))
                                ...
                                f_m06_2x = open("/home/saumen/abhisek/project_HBf/dft_m06-2x_6311g-xcoarse_template.nw",'r')
                                filedata=f_m06_2x.read()
                                f_m06_2x.close()
                                newdata = filedata.replace("  N##",("  "+items))
                    ...
                    try:
                        f_m06_2x = open("/home/saumen/abhisek/project_HBf/odft_m06-2x_631g_template.nw",'r')
                        filedata=f_m06_2x.read()
                        f_m06_2x.close()
                        ...
                        try:
                            ...
                            f_m06_2x = open("/home/saumen/abhisek/project_HBf/odft_m06-2x_6311g-fine_template.nw",'r')
                            filedata=f_m06_2x.read()
                            f_m06_2x.close()
                            #> Now if atom 3 is N them we might get multiplicity error, so if-else loop required...
                            if split_items[6][-1] != 'N':
                        ...
                        #Going for 6-311g(coarse-grid) exception ...
                            ...
                            try:
                                ...
                                f_m06_2x = open("/home/saumen/abhisek/project_HBf/odft_m06-2x_6311g-coarse_template.nw",'r')
                                filedata=f_m06_2x.read()
                                f_m06_2x.close()
                                #> Now if atom 3 is N them we might get multiplicity error, so if-else loop required...
                                if split_items[6][-1] != 'N':
                                ...
                                f_m06_2x = open("/home/saumen/abhisek/project_HBf/odft_m06-2x_6311g-xcoarse_template.nw",'r')
                                filedata=f_m06_2x.read()
                                f_m06_2x.close()
                                #> Now if atom 3 is N them we might get multiplicity error, so if-else loop required...
                                if split_items[6][-1] != 'N':
            ...
            mp2_energy=[]   #converting the energy value in string and storing here for extending the HB-output_list later...
            for energy in mp2:
                mp2_string_value=str(energy)
                mp2_energy.append(mp2_string_value)
            ...
            #--------------------------------------------------------------------------------------
            for items, mp2_value in zip(HB_output_list, mp2_energy):
                #print items, m06_2x_value,m06_2x_value, m06_HF_value
                new_line=items +"    "+ mp2_value
...
print "                                          PROGRAM NAME: HB_radar_walk_MP2_v.0.1 "
